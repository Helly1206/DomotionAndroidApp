...
public class ZoomLayout extends FrameLayout implements ZoomEngine.Listener {
    ...
    public ZoomLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        boolean setTopLeft = a.getBoolean(R.styleable.ZoomEngine_posTopLeft, false);
        float initialZoom = a.getFloat(R.styleable.ZoomEngine_initialZoom, -1);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        return performClick() || mEngine.onTouchEvent(ev) || (mHasClickableChildren && super.onTouchEvent(ev));
    }
    ...
    public void setHasClickableChildren(boolean hasClickableChildren) {
        Log.i(TAG, "setHasClickableChildren:"+ "old:"+ mHasClickableChildren+ "new:"+ hasClickableChildren);
