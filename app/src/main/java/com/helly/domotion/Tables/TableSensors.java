...
public class TableSensors extends TableBuilder {
    TableSensors(View view, Activity activity) {
        super(view, activity);
    }
    ...
    public TableLayout CreateTable() {
        ...
        TableLayout tl = view.get().findViewById(R.id.ControlsNoConnTable);
        tl.removeAllViews();
        tl = view.get().findViewById(R.id.ControlsTable);
        tl.removeAllViews();
        return tl;
    }
    ...
    public TableLayout CreateNoConnTable() {
        ...
        TableLayout tl = view.get().findViewById(R.id.ControlsTable);
        tl.removeAllViews();
        tl = view.get().findViewById(R.id.ControlsNoConnTable);
        tl.removeAllViews();
        return tl;
    }
    ...
    public void CreateButtons(TableRow tr, JSONArray RowData) {
        ...
        if (RowData.optInt(4) > 0) { // Digital
            buttonType = ButtonInterface.ButtonType.CONTROL;
        } else { // Analog
